...
/* Plans */
// Étterem konzol panel létrehozása, és az idő szinkronizálása a központ alapján
+!start <- gui.konzol("Etterem"); .wait(0); .send(kozpont,achieve,timeRequest).
